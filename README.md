...
Изменения разные и не очень сложные, как правило это перевод на Русский, удаление лишних файлов, изменение иконок под темную тему, самой темы расширений, и т.п. Некоторые расширения с измененным css требуют наличия глобальных или частных темных стилей в userContent.css для своих страниц настроек и поп-апов.
